...
const TYPE = "public";
const APP_ID = "2ef7beea";
const APP_KEY = "015eb00ccbf837c88967335ddefd9489";
...
Future<RecipeBlock>? search_recipes(String query, double startCal, double endCal) async {
  ...
  if (startSet && endSet){
    formattedQuery =
    "type=$TYPE&beta=true&app_id=$APP_ID&app_key=$APP_KEY&q=$query&calories=$startCal-$endCal";
  }
  else if (startSet){
    formattedQuery =
    "type=$TYPE&beta=true&app_id=$APP_ID&app_key=$APP_KEY&q=$query&calories=$startCal%2B";
  }
  else if (endSet){
    formattedQuery =
    "type=$TYPE&beta=true&app_id=$APP_ID&app_key=$APP_KEY&q=$query&calories=$endCal";
  }
  else { //no range
    formattedQuery =
    "type=$TYPE&beta=true&app_id=$APP_ID&app_key=$APP_KEY&q=$query";
  }
  //print(formattedQuery); //debug
...
Future<RecipeBlock>? findByUrl(String query) async {
